...
/**
 * Definition Editor adapter over the canonical generation core.
 */
final class EditorDefinitionGenerationService {
  ...
  public function generateItemDefinition(array $arguments, DefinitionEditorGmToolContext $context): array {
    ...
    return $this->generation->completeJson('generate_item_definition', 'editor_generation_item_definition', $input['seed'], 2000,
      fn(array $prior_findings): string => $this->definitionPrompt('item', $input, $context, $prior_findings, $this->itemShape()),
  ...
  public function generateCreatureDefinition(array $arguments, DefinitionEditorGmToolContext $context): array {
    $this->assertScope($context, 'creature');
    $input = [
      'prompt' => $this->boundedString($arguments, 'prompt', TRUE, 1, 2000),
    ...
    return $this->generation->completeJson('generate_creature_definition', 'editor_generation_creature_definition', $input['seed'], 4000,
      fn(array $prior_findings): string => $this->definitionPrompt('creature', $input, $context, $prior_findings, $this->creatureShape($input)),
  ...
  public function generateNpcDefinition(array $arguments, DefinitionEditorGmToolContext $context): array {
    $this->assertScope($context, 'actor');
    $input = [
      'prompt' => $this->boundedString($arguments, 'prompt', TRUE, 1, 2000),
    ...
    return $this->generation->completeJson('generate_npc_definition', 'editor_generation_npc_definition', $input['seed'], 4000,
      fn(array $prior_findings): string => $this->definitionPrompt('actor', $input, $context, $prior_findings, $this->actorShape($input)),
  ...
  private function definitionPrompt(string $family, array $input, DefinitionEditorGmToolContext $context, array $prior_findings, array $shape): string {
