...
class EditorGenerationService {
  ...
  public function generateRoomLayout(array $arguments, RoomEditorGmToolContext $context): array {
    ...
    return $this->withValidatedCompletion('generate_room_layout', $operation, $input['seed'], 3000,
  ...
  public function generateDungeonLayout(array $arguments, DungeonEditorGmToolContext $context): array {
    ...
    return $this->withValidatedCompletion('generate_dungeon_layout', $operation, $input['seed'], 3000,
  ...
  private function withValidatedCompletion(string $tool, string $operation, int $seed, int $max_tokens, callable $prompt_builder, callable $converter): array {
  ...
  private function promptText(string $surface, array $input, array $draft, array $payload): string {
    $document = [
      ...
      'originality_rule_ad_14' => self::ORIGINALITY_INSTRUCTION,
    ] + $payload;
  ...
  private function envelopesFromSteps(array $steps, int $base_revision, int $seed): array {
    ...
    foreach ($steps as $index => $step) {
      $envelopes[] = [
        ...
        'issued_at' => gmdate(DATE_RFC3339, $this->time->getRequestTime()),
      ];
    }
    return $envelopes;
  }
