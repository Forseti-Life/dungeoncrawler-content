  ...
  public function overview() {
    $hierarchyRows = [
      [
        ...
        'layer' => 'Page flow',
        'parent' => '/architecture',
        'surface' => '/charactersetup → embedded /characters/create/step/{step} → /characters/{character_id}',
        'controller_api' => 'CharacterSetupController + CharacterCreationStepController + CharacterCreationStepForm + CharacterViewController',
        'tables' => 'dc_campaign_characters',
      ],
      [
        'domain' => 'Character Creation',
        'layer' => 'API flow',
        'parent' => '/charactersetup',
        ...
        'controller_api' => 'CharacterSetupController + CharacterApiController + AbilityScoreApiController + CharacterStateController',
