- Status: done
- Completed: 2026-04-19T04:20:10Z

# Test Plan Design: dc-som-secrets-of-magic
...
`qa-suites/products/dungeoncrawler/features/dc-som-secrets-of-magic.json`
...
1. **Create** `features/dc-som-secrets-of-magic/03-test-plan.md` — the test spec:
   - List every test case derived from the AC
   - For each: test description, which suite it will live in, expected HTTP status or behavior, roles covered
   - Flag any AC items that cannot be expressed as automation (note to PM)
2. **Create** `qa-suites/products/dungeoncrawler/features/dc-som-secrets-of-magic.json` from `templates/qa-feature-suite.json`:
   ...
   - Point `test_plan` at `features/dc-som-secrets-of-magic/03-test-plan.md`
   - Validate with:
     ```bash
     python3 scripts/qa-suite-validate.py --product dungeoncrawler --feature-id dc-som-secrets-of-magic
     ```
2. **Signal completion:**
    ```bash
    ./scripts/qa-pm-testgen-complete.sh dungeoncrawler dc-som-secrets-of-magic "<brief summary>"
   ```
