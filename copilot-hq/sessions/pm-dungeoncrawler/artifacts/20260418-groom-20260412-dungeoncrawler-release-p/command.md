# Groom Next Release: 20260412-dungeoncrawler-release-p

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-o
- Next release (your target): 20260412-dungeoncrawler-release-p
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-p is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-p only.
...
For each feature selected into 20260412-dungeoncrawler-release-p:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-p starts is automatically deferred.
