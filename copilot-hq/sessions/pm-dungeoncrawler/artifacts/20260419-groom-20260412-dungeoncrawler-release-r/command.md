# Groom Next Release: 20260412-dungeoncrawler-release-r

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-q
- Next release (your target): 20260412-dungeoncrawler-release-r
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-r is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-r only.
...
For each feature selected into 20260412-dungeoncrawler-release-r:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-r starts is automatically deferred.
