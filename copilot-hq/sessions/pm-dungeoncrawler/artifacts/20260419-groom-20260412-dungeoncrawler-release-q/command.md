# Groom Next Release: 20260412-dungeoncrawler-release-q

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-p
- Next release (your target): 20260412-dungeoncrawler-release-q
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-q is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-q only.
...
For each feature selected into 20260412-dungeoncrawler-release-q:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-q starts is automatically deferred.
