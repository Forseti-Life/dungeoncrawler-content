...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260420-fix-signoff-reminder-duplicate-dispatch
- Dev outbox evidence: sessions/dev-infra/outbox/20260420-fix-signoff-reminder-duplicate-dispatch.md
