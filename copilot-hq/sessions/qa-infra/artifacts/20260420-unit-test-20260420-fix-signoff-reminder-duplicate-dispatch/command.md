- command: |
    ...
    - Completed item: 20260420-fix-signoff-reminder-duplicate-dispatch
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260420-fix-signoff-reminder-duplicate-dispatch.md
