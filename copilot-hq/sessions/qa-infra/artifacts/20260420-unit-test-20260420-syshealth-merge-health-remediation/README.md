...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260420-syshealth-merge-health-remediation
- Dev outbox evidence: sessions/dev-infra/outbox/20260420-syshealth-merge-health-remediation.md
