- command: |
    ...
    - Completed item: 20260419-fix-groom-dispatch-off-by-one-release-id
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260419-fix-groom-dispatch-off-by-one-release-id.md
