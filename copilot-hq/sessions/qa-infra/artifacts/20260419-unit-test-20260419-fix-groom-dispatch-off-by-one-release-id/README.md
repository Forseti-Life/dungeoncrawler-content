...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260419-fix-groom-dispatch-off-by-one-release-id
- Dev outbox evidence: sessions/dev-infra/outbox/20260419-fix-groom-dispatch-off-by-one-release-id.md
