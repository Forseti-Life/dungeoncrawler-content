# Push ready: 20260412-forseti-release-p

All required PM signoffs recorded for coordinated release `20260412-forseti-release-p`.
...
1. Verify: `bash scripts/release-signoff-status.sh 20260412-forseti-release-p`
