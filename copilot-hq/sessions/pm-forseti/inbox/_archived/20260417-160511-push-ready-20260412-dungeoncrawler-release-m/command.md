# Push ready: 20260412-dungeoncrawler-release-m

All required PM signoffs recorded for coordinated release `20260412-dungeoncrawler-release-m`.
...
1. Verify: `bash scripts/release-signoff-status.sh 20260412-dungeoncrawler-release-m`
