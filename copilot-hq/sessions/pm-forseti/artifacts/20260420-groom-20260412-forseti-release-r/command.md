...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-r is instant scope selection.
...
For each feature selected into 20260412-forseti-release-r:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-r starts is automatically deferred.
