# Groom Next Release: 20260412-forseti-release-p

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-o
- Next release (your target): 20260412-forseti-release-p
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-p is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-p only.
...
For each feature selected into 20260412-forseti-release-p:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-p starts is automatically deferred.
