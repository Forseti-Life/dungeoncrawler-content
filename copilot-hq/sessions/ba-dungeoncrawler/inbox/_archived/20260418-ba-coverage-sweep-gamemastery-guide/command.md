# BA Coverage Sweep — PF2E Gamemastery Guide
...
3. `docs/dungeoncrawler/PF2requirements/audit/gmg-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/gmg-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `4` / `4`
- audit pending markers: `1000`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `gamemastery-guide`.
