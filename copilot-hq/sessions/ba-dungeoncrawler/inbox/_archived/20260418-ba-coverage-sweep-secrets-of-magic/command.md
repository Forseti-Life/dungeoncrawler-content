# BA Coverage Sweep — PF2E Secrets of Magic
...
3. `docs/dungeoncrawler/PF2requirements/audit/som-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/som-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `5` / `5`
- audit pending markers: `843`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `secrets-of-magic`.
