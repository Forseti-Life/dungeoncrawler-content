# BA Coverage Sweep — PF2E Bestiary 2
...
3. `docs/dungeoncrawler/PF2requirements/audit/b2-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/b2-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `2` / `2`
- audit pending markers: `599`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `bestiary-2`.
