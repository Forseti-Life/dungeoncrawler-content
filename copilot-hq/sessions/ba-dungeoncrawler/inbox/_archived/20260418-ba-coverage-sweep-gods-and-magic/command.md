# BA Coverage Sweep — PF2E Gods and Magic
...
3. `docs/dungeoncrawler/PF2requirements/audit/gam-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/gam-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `6` / `6`
- audit pending markers: `269`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `gods-and-magic`.
