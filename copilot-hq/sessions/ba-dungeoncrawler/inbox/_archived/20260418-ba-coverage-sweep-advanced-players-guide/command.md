...
3. `docs/dungeoncrawler/PF2requirements/audit/apg-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/apg-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `7` / `6`
- audit pending markers: `1073`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `advanced-players-guide`.
