# BA Coverage Sweep — PF2E Guns and Gears
...
3. `docs/dungeoncrawler/PF2requirements/audit/gng-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/gng-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `5` / `5`
- audit pending markers: `726`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `guns-and-gears`.
