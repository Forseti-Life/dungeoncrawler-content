# BA Coverage Sweep — PF2E Bestiary 3
...
3. `docs/dungeoncrawler/PF2requirements/audit/b3-audit.md`
4. `docs/dungeoncrawler/PF2requirements/references/b3-*.md`

## Current validation signal

- requirements_status: `complete`
- reference docs: `3` / `3`
- audit pending markers: `620`
- audit needs-review markers: `1`

## Your task

1. Read the tracker, audit worksheet, and reference docs for `bestiary-3`.
