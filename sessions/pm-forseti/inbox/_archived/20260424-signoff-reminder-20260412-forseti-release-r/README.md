# Release signoff reminder: 20260412-forseti-release-r
...
Release `20260412-forseti-release-r` is blocked because your PM signoff is missing.

Run:
```bash
bash scripts/release-signoff.sh forseti 20260412-forseti-release-r
```
