# Groom Next Release: 20260412-forseti-release-s

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-r
- Next release (your target): 20260412-forseti-release-s
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-s is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-s only.
...
For each feature selected into 20260412-forseti-release-s:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-s starts is automatically deferred.
