# Groom Next Release: 20260412-forseti-release-x

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-w
- Next release (your target): 20260412-forseti-release-x
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-x is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-x only.
...
For each feature selected into 20260412-forseti-release-x:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-x starts is automatically deferred.
