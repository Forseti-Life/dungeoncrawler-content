# Groom Next Release: 20260412-forseti-release-v

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-u
- Next release (your target): 20260412-forseti-release-v
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-v is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-v only.
...
For each feature selected into 20260412-forseti-release-v:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-v starts is automatically deferred.
