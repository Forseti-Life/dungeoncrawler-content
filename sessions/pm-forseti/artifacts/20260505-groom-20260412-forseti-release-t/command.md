- Status: done
- Completed: 2026-05-05T18:57:28Z

# Groom Next Release: 20260412-forseti-release-t

- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-s
- Next release (your target): 20260412-forseti-release-t
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-t is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-t only.
...
For each feature selected into 20260412-forseti-release-t:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-t starts is automatically deferred.
