...
- Dispatched-at: 2026-04-28T11:30:06Z
...
Agent `pm-infra` has latest outbox `20260428-escalation-qa-infra-needs-info-quarantine.md` with status `needs-info`, but no supervisor escalation item exists.
