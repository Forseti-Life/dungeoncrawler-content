...
- Escalated item: 20260428-backlog-triage-open-source
- Escalated status: needs-info


## Issue

Agent `pm-open-source` has latest outbox `20260428-backlog-triage-open-source.md` with status `needs-info`, but no supervisor escalation item exists.
