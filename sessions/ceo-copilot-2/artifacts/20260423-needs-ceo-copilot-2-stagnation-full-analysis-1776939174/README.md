...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T10:11:52.568357+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 48m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 574m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 83h 23m (threshold 2h)
...
- agent-code-review: `20260422-clarify-escalation-20260420-code-review-forseti.life-20260419-forseti-release-c` (48m old)
- agent-code-review: `20260419-code-review-dungeoncrawler-20260412-dungeoncrawler-release-n` (48m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (38m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (38m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (38m old)
