...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T23:03:40.869264+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 136m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 1346m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 96h 15m (threshold 2h)
...
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (45m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (45m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (45m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-executor-failures-prune` (45m old)
- qa-infra: `20260421-unit-test-20260422-syshealth-merge-health-remediation` (45m old)
