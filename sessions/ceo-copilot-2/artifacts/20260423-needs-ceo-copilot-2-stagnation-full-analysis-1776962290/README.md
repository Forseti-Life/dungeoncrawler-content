...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T16:37:08.527262+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 19m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 959m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 89h 48m (threshold 2h)
...
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (35m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (35m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (35m old)
- qa-infra: `20260417-unit-test-20260417-syshealth-executor-failures-prune` (35m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-executor-failures-prune` (35m old)
