...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T08:37:01.068678+00:00
...
## Signals fired (3):
  ...
  - INBOX_AGING: oldest unresolved inbox item is 479m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 81h 48m (threshold 2h)
...
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (20m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (20m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (20m old)
- qa-infra: `20260417-unit-test-20260417-syshealth-executor-failures-prune` (20m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-executor-failures-prune` (20m old)
