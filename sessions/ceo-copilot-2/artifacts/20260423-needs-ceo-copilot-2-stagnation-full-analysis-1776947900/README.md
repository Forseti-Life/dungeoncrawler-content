...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T12:37:18.789869+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 97m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 720m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 85h 48m (threshold 2h)
...
- agent-code-review: `20260422-clarify-escalation-20260420-code-review-forseti.life-20260419-forseti-release-c` (193m old)
- agent-code-review: `20260419-code-review-dungeoncrawler-20260412-dungeoncrawler-release-n` (193m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (37m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (37m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (37m old)
