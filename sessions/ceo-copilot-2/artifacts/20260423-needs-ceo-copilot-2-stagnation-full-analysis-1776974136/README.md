...
- Status: pending
- Supervisor: board
- Created: 2026-04-23T19:54:35.072498+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 217m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 1157m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 93h 6m (threshold 2h)
...
- agent-code-review: `20260422-clarify-escalation-20260420-code-review-forseti.life-20260419-forseti-release-c` (217m old)
- agent-code-review: `20260419-code-review-dungeoncrawler-20260412-dungeoncrawler-release-n` (217m old)
