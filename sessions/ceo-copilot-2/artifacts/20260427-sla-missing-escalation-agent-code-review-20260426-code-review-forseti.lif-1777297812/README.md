...
- Dispatched-at: 2026-04-27T13:20:06Z
...
Agent `agent-code-review` has latest outbox `20260426-code-review-forseti.life-20260412-forseti-release-u.md` with status `needs-info`, but no supervisor escalation item exists.
