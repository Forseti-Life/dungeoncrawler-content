...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T00:02:51.716185+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 195m (threshold 15m)
  - INBOX_AGING: oldest unresolved inbox item is 1405m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 97h 14m (threshold 2h)
...
- qa-infra: `20260421-unit-test-20260421-syshealth-merge-health-remediation` (41m old)
- qa-infra: `20260423-unit-test-20260417-fix-from-qa-block-infrastructure` (41m old)
- qa-infra: `20260422-unit-test-20260422-syshealth-executor-failures-prune` (41m old)
- qa-infra: `20260421-unit-test-20260421-syshealth-executor-failures-prune` (41m old)
- qa-infra: `20260421-unit-test-20260422-syshealth-merge-health-remediation` (41m old)
