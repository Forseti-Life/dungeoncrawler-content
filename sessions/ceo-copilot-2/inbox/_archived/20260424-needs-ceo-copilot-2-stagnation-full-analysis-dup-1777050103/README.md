...
- Status: pending
- Supervisor: board
- Created: 2026-04-24T16:59:44.457214+00:00
...
## Signals fired (2):
  - INBOX_AGING: oldest unresolved inbox item is 1078m old (threshold 30m)
  - NO_RELEASE_PROGRESS: no release signoff in 17h 58m (threshold 2h)
...
- ceo-copilot-2: `20260424-rca-persistent-blocker-Merge-health-1-tracked-local-change-s-1-untracke` (0m old)
- pm-infra: `20260424-sla-missing-escalation-qa-infra-20260424-verify-dev-item-prep-dr` (0m old)
