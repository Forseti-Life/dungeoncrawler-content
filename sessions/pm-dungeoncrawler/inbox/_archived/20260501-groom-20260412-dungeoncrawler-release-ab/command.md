# Groom Next Release: 20260412-dungeoncrawler-release-ab

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-aa
- Next release (your target): 20260412-dungeoncrawler-release-ab
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-ab is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-ab only.
...
For each feature selected into 20260412-dungeoncrawler-release-ab:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-ab starts is automatically deferred.
