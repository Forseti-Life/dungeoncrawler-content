# Groom Next Release: 20260412-dungeoncrawler-release-z

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-y
- Next release (your target): 20260412-dungeoncrawler-release-z
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-z is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-z only.
...
For each feature selected into 20260412-dungeoncrawler-release-z:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-z starts is automatically deferred.
