...
- `features/dc-cr-elf-heritage-arctic/feature.md` ✓
...
Added 5 QA cases covering arctic elf heritage, edge handling, and validation; suite validated.
...
If you want to review the test plan:
  cat features/dc-cr-elf-heritage-arctic/03-test-plan.md

If you want to review the runnable suite metadata:
  cat qa-suites/products/dungeoncrawler/features/dc-cr-elf-heritage-arctic.json
