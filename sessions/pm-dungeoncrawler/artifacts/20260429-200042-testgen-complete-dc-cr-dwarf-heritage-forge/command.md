...
- `features/dc-cr-dwarf-heritage-forge/feature.md` ✓
- `features/dc-cr-dwarf-heritage-forge/01-acceptance-criteria.md` ✓
- `features/dc-cr-dwarf-heritage-forge/03-test-plan.md` ✓
- `qa-suites/products/dungeoncrawler/features/dc-cr-dwarf-heritage-forge.json` ✓

## QA summary

Added 5 QA cases covering dwarf heritage — forge dwarf, edge handling, and validation; suite validated.
...
If you want to review the test plan:
  cat features/dc-cr-dwarf-heritage-forge/03-test-plan.md

If you want to review the runnable suite metadata:
  cat qa-suites/products/dungeoncrawler/features/dc-cr-dwarf-heritage-forge.json
