...
- `features/dc-cr-dwarf-heritage-rock/feature.md` ✓
- `features/dc-cr-dwarf-heritage-rock/01-acceptance-criteria.md` ✓
...
Added 5 QA cases covering dwarf heritage — rock dwarf, edge handling, and validation; suite validated.
...
If you want to review the test plan:
  cat features/dc-cr-dwarf-heritage-rock/03-test-plan.md
