# Groom Next Release: 20260412-dungeoncrawler-release-u

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-t
- Next release (your target): 20260412-dungeoncrawler-release-u
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-u is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-u only.
...
For each feature selected into 20260412-dungeoncrawler-release-u:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-u starts is automatically deferred.
