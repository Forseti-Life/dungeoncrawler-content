- Status: done
- Completed: 2026-05-05T18:58:27Z

# Groom Next Release: 20260412-dungeoncrawler-release-w

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-v
- Next release (your target): 20260412-dungeoncrawler-release-w
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-w is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-w only.
...
For each feature selected into 20260412-dungeoncrawler-release-w:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-w starts is automatically deferred.
