...
export class CharacterPanel {
  ...
  init(dungeonData, stateManager) {
    ...
    this._el = {
      entityInfoPanel:    id('char-entity-info')     || s('entity-info'),
      entityName:         s('entity-name')           || id('entity-name'),
      ...
      // Character sheet
      charPortraitWrap:   id('char-portrait-wrap'),
      charPortrait:       id('char-portrait')        || s('portrait'),
      charName:           id('char-name'),
      charClass:          id('char-class'),
      charLevel:          id('char-level'),
      charPersonalityWrap: id('char-personality-wrap'),
      charPersonality:    id('char-personality'),
      charBackstoryWrap:  id('char-backstory-wrap'),
      charBackstory:      id('char-backstory'),
      charEntityInfo:     id('char-entity-info'),
