...
### Routes (`job_application_automation.routing.yml`)
- `job_application_automation.start_job_discovery`: Main discovery page
- `job_application_automation.job_discovery_search`: AJAX search endpoint
...
### Configuration
- `job_application_automation.libraries.yml`: Added job_discovery library
- `job_application_automation.module`: Registered theme hook
- `job_application_automation.services.yml`: Registered scraping service
- `job_application_automation.local_tasks.yml`: Added navigation tab
