...
```bash
cd /home/ubuntu/forseti.life/copilot-hq
PERSONA_SESSION_PATH="$(bash scripts/persona-copilot-session.sh architect-copilot --path)"
...
bash scripts/persona-copilot-session.sh architect-copilot --activate-current >/dev/null
...
| forseti.life site root | `/home/ubuntu/forseti.life/copilot-hq/sites/forseti/` |
| forseti.life web root | `/home/ubuntu/forseti.life/copilot-hq/sites/forseti/web/` |
| Custom modules (forseti) | `/home/ubuntu/forseti.life/copilot-hq/sites/forseti/web/modules/custom/` |
| dungeoncrawler site root | `/home/ubuntu/forseti.life/copilot-hq/sites/dungeoncrawler/` |
| Shared modules | `/home/ubuntu/forseti.life/copilot-hq/shared/modules/` |
