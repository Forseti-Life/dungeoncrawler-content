...

{
  ...
  updatePendingChatProgress.call(
    panel,
    pending,
    'Round 0: Turn 1: Actor Initiative Order: Resolving nearby NPC turns...',
    'npc-reactions',
  ...
  assert(appended[0].message === 'Round 0: Turn 1: Actor Initiative Order: Resolving nearby NPC turns...', 'progress updates use the stable prefixed initiative-order wording');
